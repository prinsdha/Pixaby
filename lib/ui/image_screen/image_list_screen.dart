...
import 'package:pixabay/core/constant/app_icons.dart';
...
import 'package:pixabay/ui/shared/app_textfield.dart';
      ...
      children: [
        GestureDetector(
          ...
          child: ClipRRect(
            ...
            child: SizedBox(
              height: 400,
              child: networkImageShow(imageDetails.webformatUrl),
            ),
          ),
        ),
        Padding(
...
class ScrollKeyboardCloser extends StatelessWidget {
  ...
  const ScrollKeyboardCloser({Key? key, required this.child}) : super(key: key);
